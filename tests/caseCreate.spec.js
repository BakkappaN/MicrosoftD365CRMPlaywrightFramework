...
import { subAreaMenuSelectors, viewSelectors, 
  ...
  CommandBarFormButtonsSelectors, ResolveCaseFormSelector } from "../selectors/commonselectors.json";
...
test('Create Case', async ({ page }) => {
  ...
  let appId = process.env.CSH_APPID;
  ...
  let caseNumber = await caseNumberControl.evaluate(e => (e).value);
